    ...
    request.onload = () => {
        ...
        if (request.status === 401 || request.status === 403) {
            ...
            for (let i = 0; i < json.length; i++) {
                ...
                detalle.innerHTML       = "<a class='btn btn-info btn-sm' href='detalle_pregunta.html?"+id_Preguntas+"'><span class='glyphicon glyphicon-list-alt'></span>  Detalle</a>";
                editar.innerHTML        = "<a class='btn btn-success btn-sm' href='update_pregunta.html?"+id_Preguntas+"'><span class='glyphicon glyphicon-pencil'></span>  Actualizar</a>";
                eliminar.innerHTML      = "<a class='btn btn-danger btn-sm' href='delete_pregunta.html?"+id_Preguntas+"'><span class='glyphicon glyphicon-trash'>  Borrar</a>";
